...
class BannerVenda(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        cliente = kwargs.get("cliente", "Cliente não especificado")
        foto_cliente = kwargs.get("foto_cliente", "default.png")
        produto = kwargs.get("produto", "Produto não especificado")
        foto_produto = kwargs.get("foto_produto", "default.png")
        data = kwargs.get("data", "Data não especificada")
        unidade = kwargs.get("unidade", "unid.")
        quantidade = kwargs.get("quantidade", 0)
        ...
        direita_label_preco = Label(text=f"Preço: R${float(preco):,.2f}", size_hint=(1, 0.33), pos_hint={"right": 1, "top": 0.65})
